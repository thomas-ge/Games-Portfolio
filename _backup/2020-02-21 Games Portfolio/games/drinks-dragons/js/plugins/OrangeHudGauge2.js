...
EnableTwo = Game_Interpreter.prototype.pluginCommand;
var enablification = new EnableTwo();
...
Game_Interpreter.prototype.pluginCommand = function(command, args) {
     EnableTwo.call(this, command, args);
...
function enableTwo() {
    ...
    if (Imported["OrangeHudGauge"] === undefined) {
      OrangeHudGauge.validateParams = function(paramsLine) {
        paramsLine.GroupName = paramsLine.GroupName || "main2";
